...
class Trainer:
    def __init__(self, train_arguments):
        ...
        train_folders = {'HR': train_arguments['training_labels'], 'LR': train_arguments['training_input']}
